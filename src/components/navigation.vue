<template>
    <nav class="global-nav">
        <div v-if="backend" class="wrap clearfix">
            <div class="left-part"><a href="/" exact class="logo-link"><i class="icon icon-nav-logo"></i><span class="hidden">xcyfed</span></a>
                <div class="main-nav">
        ...
        <div v-else class="wrap clearfix">
            <div class="left-part">
                <router-link to="/" active-class="current" exact class="logo-link"><i class="icon icon-nav-logo"></i><span class="hidden">xcyfed</span></router-link>
                <div class="main-nav">
            ...
            <div class="right-part">
                ...
                <span v-if="isLogin" class="nav-me"><router-link to="/user/account" class="nav-me-link"><img src="https://wbcz.github.io/images/avatar.png" class="nav-avatar-img"></router-link></span>
